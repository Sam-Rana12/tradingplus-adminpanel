  ...
  return (
    <>
      <div className="flex h-screen w-full items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-slate-200" >
        <div className="h-[70%] w-[40%] flex justify-center bg-slate-700 py-[5%] rounded-xl">
          <div className="w-full max-w-md space-y-8">
            <div>
              <h1 className="text-center-6 text-center text-3xl font-bold tracking-tight text-slate-100">
                Trading Plus
              </h1>
              <h4 className="mt-6 text-center text-xl tracking-tight text-slate-100">
